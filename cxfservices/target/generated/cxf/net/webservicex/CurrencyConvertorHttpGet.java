...
public interface CurrencyConvertorHttpGet {
    ...
    public double conversionRate(
        @WebParam(partName = "FromCurrency", name = "FromCurrency", targetNamespace = "")
        java.lang.String fromCurrency,
        @WebParam(partName = "ToCurrency", name = "ToCurrency", targetNamespace = "")
