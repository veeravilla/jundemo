 ...
 * 2015-07-25T10:47:46.953-05:00
 * Generated source version: 3.1.0
 * 
 */
@WebServiceClient(name = "CurrencyConvertor", 
                  wsdlLocation = "file:/C:/JuneWorkspace/cxfservices/src/main/resources/wsdl/CurrencyConvertor.wsdl",
...
public class CurrencyConvertor extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/JuneWorkspace/cxfservices/src/main/resources/wsdl/CurrencyConvertor.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CurrencyConvertor.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/JuneWorkspace/cxfservices/src/main/resources/wsdl/CurrencyConvertor.wsdl");
        }
        WSDL_LOCATION = url;
    }
